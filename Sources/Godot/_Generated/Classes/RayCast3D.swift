...
open class RayCast3D: Node3D {
    ...
    private static var __method_binding_force_raycast_update: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "force_raycast_update").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_set_hit_from_inside: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_hit_from_inside").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    private static var __method_binding_is_hit_from_inside_enabled: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "is_hit_from_inside_enabled").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    private func __setDebugShapeCustomColor(_ debugShapeCustomColor: Godot.Color) {
        withUnsafePointer(to: debugShapeCustomColor) { (__ptr_debugShapeCustomColor) in
    ...
    private static var __method_binding_set_debug_shape_thickness: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_debug_shape_thickness").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1286410249)!
        }
        }
    }()
    private func __setDebugShapeThickness(_ debugShapeThickness: Int32) {
        withUnsafePointer(to: debugShapeThickness) { (__ptr_debugShapeThickness) in
    ...
    private static var __method_binding_get_debug_shape_thickness: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_debug_shape_thickness").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3905245786)!
        }
        }
    }()
