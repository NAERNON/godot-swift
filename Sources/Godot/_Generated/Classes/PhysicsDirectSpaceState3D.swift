...
open class PhysicsDirectSpaceState3D: Object {
    private static var __method_binding_intersect_point: GDExtensionMethodBindPtr = {
        ...
        GodotStringName(swiftString: "intersect_point").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 45993382)!
        }
        }
    }()
    public func intersectPoint(parameters: Godot.PhysicsPointQueryParameters3D?, maxResults: Int32 = 32) -> Godot.GodotTypedArray<Godot.GodotDictionary> {
    ...
    private static var __method_binding_intersect_ray: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "intersect_ray").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3957970750)!
        }
        }
    }()
    public func intersectRay(parameters: Godot.PhysicsRayQueryParameters3D?) -> Godot.GodotDictionary {
    ...
    private static var __method_binding_intersect_shape: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "intersect_shape").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 550215980)!
        }
        }
    }()
    public func intersectShape(parameters: Godot.PhysicsShapeQueryParameters3D?, maxResults: Int32 = 32) -> Godot.GodotTypedArray<Godot.GodotDictionary> {
        let __temporary = Godot.GodotTypedArray<Godot.GodotDictionary>()
        parameters.withUnsafeRawPointer { (__ptr_parameters) in
            withUnsafePointer(to: __ptr_parameters) { (_ptr___ptr_parameters) in
                withUnsafePointer(to: maxResults) { (__ptr_maxResults) in
    ...
    private static var __method_binding_cast_motion: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "cast_motion").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_collide_shape: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "collide_shape").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 550215980)!
        }
        }
    }()
    public func collideShape(parameters: Godot.PhysicsShapeQueryParameters3D?, maxResults: Int32 = 32) -> Godot.GodotTypedArray<Godot.Vector3> {
        let __temporary = Godot.GodotTypedArray<Godot.Vector3>()
        parameters.withUnsafeRawPointer { (__ptr_parameters) in
            withUnsafePointer(to: __ptr_parameters) { (_ptr___ptr_parameters) in
                withUnsafePointer(to: maxResults) { (__ptr_maxResults) in
                    withUnsafeArgumentPackPointer(_ptr___ptr_parameters, __ptr_maxResults) { (__accessPtr) in
    ...
    private static var __method_binding_get_rest_info: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_rest_info").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1376751592)!
        }
        }
    }()
    public func restInfo(parameters: Godot.PhysicsShapeQueryParameters3D?) -> Godot.GodotDictionary {
        let __temporary = Godot.GodotDictionary()
        parameters.withUnsafeRawPointer { (__ptr_parameters) in
            withUnsafePointer(to: __ptr_parameters) { (_ptr___ptr_parameters) in
                withUnsafeArgumentPackPointer(_ptr___ptr_parameters) { (__accessPtr) in
