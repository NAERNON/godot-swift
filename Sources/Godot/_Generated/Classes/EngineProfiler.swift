...
open class EngineProfiler: RefCounted {
    open func _toggle(enable: Bool, options: Godot.GodotArray) {
    }

    open func _addFrame(data: Godot.GodotArray) {
    }
    ...
    internal override class func virtualFunctions() -> [GodotStringName: (godotName: GodotStringName, call: GDExtensionClassCallVirtual)] {
        ...
        ._toggle(
            ...
            options: Godot.GodotArray(godotExtensionPointer: args[1]!)
        )}
        let _add_frame_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            let _ = instance
        ._addFrame(
            data: Godot.GodotArray(godotExtensionPointer: args[0]!)
        )}
