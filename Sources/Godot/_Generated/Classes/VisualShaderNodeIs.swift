...
open class VisualShaderNodeIs: VisualShaderNode {
    ...
    private static var __method_binding_set_function: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1438374690)!
        }
        }
    }()
    private func __setFunction(`func`: Godot.VisualShaderNodeIs.Function) {
    ...
    private static var __method_binding_get_function: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 580678557)!
        }
        }
    }()
    private func __getFunction() -> Godot.VisualShaderNodeIs.Function {
        var __temporary = Godot.VisualShaderNodeIs.Function.RawValue(0)
        ...
        return Godot.VisualShaderNodeIs.Function(rawValue: __temporary)!
    }
