...
open class CylinderMesh: PrimitiveMesh {
    private static var __method_binding_set_top_radius: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_top_radius").withUnsafeRawPointer { __ptr__method_name in
            ...
            withUnsafeArgumentPackPointer(__ptr_radius) { (__accessPtr) in
                `self`.withUnsafeRawPointer { (__ptr_self) in
                    gdextension_interface_object_method_bind_ptrcall(
                        Self.__method_binding_set_top_radius,
                        __ptr_self,
                        __accessPtr,
                        nil
                    )
    ...
    private static var __method_binding_get_top_radius: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_top_radius").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __getTopRadius() -> Double {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                gdextension_interface_object_method_bind_ptrcall(
                    Self.__method_binding_get_top_radius,
                    __ptr_self,
                    nil,
                    __ptr___temporary
                )
    ...
    private static var __method_binding_set_bottom_radius: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_bottom_radius").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 373806689)!
        }
        }
    }()
    private func __setBottomRadius(_ radius: Double) {
        withUnsafePointer(to: radius) { (__ptr_radius) in
            withUnsafeArgumentPackPointer(__ptr_radius) { (__accessPtr) in
                `self`.withUnsafeRawPointer { (__ptr_self) in
                    gdextension_interface_object_method_bind_ptrcall(
                        Self.__method_binding_set_bottom_radius,
                        __ptr_self,
                        __accessPtr,
                        nil
                    )
    ...
    private static var __method_binding_get_bottom_radius: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_bottom_radius").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1740695150)!
        }
        }
    }()
    private func __getBottomRadius() -> Double {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                gdextension_interface_object_method_bind_ptrcall(
                    Self.__method_binding_get_bottom_radius,
                    __ptr_self,
                    nil,
                    __ptr___temporary
                )
    ...
    private static var __method_binding_set_radial_segments: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_radial_segments").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1286410249)!
        }
        }
    }()
    private func __setRadialSegments(_ segments: Int32) {
        withUnsafePointer(to: segments) { (__ptr_segments) in
    ...
    private static var __method_binding_get_radial_segments: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_radial_segments").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __setRings(_ rings: Int32) {
        withUnsafePointer(to: rings) { (__ptr_rings) in
    ...
    private static var __method_binding_set_cap_top: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_cap_top").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    private func __setCapTop(_ capTop: Bool) {
        withUnsafePointer(to: capTop) { (__ptr_capTop) in
    ...
    private static var __method_binding_is_cap_top: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "is_cap_top").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_set_cap_bottom: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_cap_bottom").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    private func __setCapBottom(_ capBottom: Bool) {
        withUnsafePointer(to: capBottom) { (__ptr_capBottom) in
    ...
    private static var __method_binding_is_cap_bottom: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "is_cap_bottom").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
