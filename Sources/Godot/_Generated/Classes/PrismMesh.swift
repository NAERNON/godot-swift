...
open class PrismMesh: PrimitiveMesh {
    private static var __method_binding_set_left_to_right: GDExtensionMethodBindPtr = {
        ...
        GodotStringName(swiftString: "set_left_to_right").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 373806689)!
        }
        }
    }()
    private func __setLeftToRight(_ leftToRight: Double) {
        withUnsafePointer(to: leftToRight) { (__ptr_leftToRight) in
            withUnsafeArgumentPackPointer(__ptr_leftToRight) { (__accessPtr) in
                `self`.withUnsafeRawPointer { (__ptr_self) in
                    gdextension_interface_object_method_bind_ptrcall(
                        Self.__method_binding_set_left_to_right,
                        __ptr_self,
                        __accessPtr,
                        nil
                    )
    ...
    private static var __method_binding_get_left_to_right: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_left_to_right").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __getLeftToRight() -> Double {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                gdextension_interface_object_method_bind_ptrcall(
                    Self.__method_binding_get_left_to_right,
                    __ptr_self,
                    nil,
                    __ptr___temporary
                )
