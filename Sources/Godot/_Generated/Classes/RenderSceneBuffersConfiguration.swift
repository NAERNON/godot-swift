...
open class RenderSceneBuffersConfiguration: RefCounted {
    ...
    private static var __method_binding_get_scaling_3d_mode: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 976778074)!
        }
        }
    }()
    ...
    private static var __method_binding_set_scaling_3d_mode: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 447477857)!
        }
        }
    }()
    ...
    private static var __method_binding_get_msaa_3d: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3109158617)!
        }
        }
    }()
    ...
    private static var __method_binding_set_msaa_3d: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3952630748)!
        }
        }
    }()
    ...
    private static var __method_binding_get_screen_space_aa: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 641513172)!
        }
        }
    }()
    ...
    private static var __method_binding_set_screen_space_aa: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 139543108)!
        }
        }
    }()
