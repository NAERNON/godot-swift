...
open class ArrayMesh: Mesh {
    ...
    private static var __method_binding_set_blend_shape_name: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_blend_shape_name").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_clear_blend_shapes: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "clear_blend_shapes").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_add_surface_from_arrays: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "add_surface_from_arrays").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 172284304)!
        }
        }
    }()
    public func addSurfaceFromArrays<Value: VariantEncodable & VariantDecodable>(primitive: Godot.Mesh.PrimitiveType, arrays: Godot.GodotArray<Value>, blendShapes: Godot.GodotArray<Godot.GodotArray<Variant>> = [], lods: Godot.GodotDictionary = [:], flags: Godot.Mesh.ArrayFormat = Mesh.ArrayFormat(rawValue: 0)) {
    ...
    private static var __method_binding_surface_update_vertex_region: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_update_vertex_region").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_update_attribute_region: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_update_attribute_region").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3837166854)!
        }
        }
    }()
    ...
    private static var __method_binding_surface_update_skin_region: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_update_skin_region").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3837166854)!
        }
        }
    }()
    ...
    private static var __method_binding_surface_get_array_len: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_get_array_len").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_get_array_index_len: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_get_array_index_len").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 923996154)!
        }
        }
    }()
    ...
    private static var __method_binding_surface_get_format: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_get_format").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_get_primitive_type: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_get_primitive_type").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_find_by_name: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_find_by_name").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_set_name: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_set_name").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_surface_get_name: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "surface_get_name").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_regen_normal_maps: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "regen_normal_maps").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3218959716)!
        }
        }
    }()
    ...
    private static var __method_binding_lightmap_unwrap: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "lightmap_unwrap").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_set_shadow_mesh: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_shadow_mesh").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_get_shadow_mesh: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "get_shadow_mesh").withUnsafeRawPointer { __ptr__method_name in
