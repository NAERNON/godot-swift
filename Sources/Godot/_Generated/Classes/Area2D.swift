...
open class Area2D: CollisionObject2D {
    ...
    private func __getGravitySpaceOverrideMode() -> Godot.Area2D.SpaceOverride {
        Godot.Area2D.SpaceOverride.fromInitializingMutatingGodotUnsafePointer { __temporary in
        `self`.withGodotUnsafeMutableRawPointer { __ptr_self in
        GodotExtension.Interface.objectMethodBindPtrcall(
    ...
    public func overlappingAreas() -> Godot.GodotArray<Godot.Area2D?> {
        Godot.GodotArray<Godot.Area2D?> .fromInitializingMutatingGodotUnsafePointer { __temporary in
        `self`.withGodotUnsafeMutableRawPointer { __ptr_self in
        GodotExtension.Interface.objectMethodBindPtrcall(
