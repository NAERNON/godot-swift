...
open class CanvasItem: Node {
    ...
    public lazy var drawSignal: Godot.EmptySignalEmitter = {
    ...
    public lazy var hiddenSignal: Godot.EmptySignalEmitter = {
    ...
    public lazy var itemRectChangedSignal: Godot.EmptySignalEmitter = {
