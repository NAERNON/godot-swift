...
open class WebRTCMultiplayerPeer: MultiplayerPeer {
    ...
    public func createServer(channelsConfig: Godot.GodotArray = []) -> Godot.ErrorType {
    ...
    public func createClient(peerId: Int32, channelsConfig: Godot.GodotArray = []) -> Godot.ErrorType {
        var __temporary = Godot.ErrorType.RawValue(0)
    ...
    public func createMesh(peerId: Int32, channelsConfig: Godot.GodotArray = []) -> Godot.ErrorType {
        var __temporary = Godot.ErrorType.RawValue(0)
        withUnsafePointer(to: peerId) { (__ptr_peerId) in
            channelsConfig.withUnsafeRawPointer { (__ptr_channelsConfig) in
                withUnsafeArgumentPackPointer(__ptr_peerId, __ptr_channelsConfig) { (__accessPtr) in
