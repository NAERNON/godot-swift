...
open class VisualShaderNodeCurveXYZTexture: VisualShaderNodeResizableBase {
    private static var __method_binding_set_texture: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 8031783)!
        }
        }
    }()
    ...
    private static var __method_binding_get_texture: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1950275015)!
        }
        }
    }()
