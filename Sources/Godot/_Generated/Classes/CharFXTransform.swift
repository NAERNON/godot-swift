...
open class CharFXTransform: RefCounted {
    ...
    private func __setVisibility(_ visibility: Bool) {
        withUnsafePointer(to: visibility) { (__ptr_visibility) in
    ...
    private func __getEnvironment() -> Godot.GodotDictionary {
    ...
    private func __setEnvironment(_ environment: Godot.GodotDictionary) {
    ...
    private func __setRelativeIndex(_ relativeIndex: Int32) {
        withUnsafePointer(to: relativeIndex) { (__ptr_relativeIndex) in
    ...
    private func __setGlyphCount(_ glyphCount: UInt8) {
        withUnsafePointer(to: glyphCount) { (__ptr_glyphCount) in
    ...
    private func __setGlyphFlags(_ glyphFlags: UInt16) {
        withUnsafePointer(to: glyphFlags) { (__ptr_glyphFlags) in
    ...
    public var environment: Godot.GodotDictionary {
        get {
            __getEnvironment()
        }
        set {
