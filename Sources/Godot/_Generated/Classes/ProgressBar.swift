...
open class ProgressBar: Range {
    ...
    internal static var __method_binding_set_show_percentage: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_percentage").withUnsafeOpaquePointer { __ptr__method_name in
    ...
    internal static var __method_binding_is_percentage_shown: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_percentage_shown").withUnsafeOpaquePointer { __ptr__method_name in
