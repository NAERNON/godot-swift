...
open class VisualShaderNodeSmoothStep: VisualShaderNode {
    ...
    internal static var __method_binding_set_op_type: GDExtensionMethodBindPtr = {
        ...
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2427426148)!
        }
        }
    }()

    private func __setOpType(
        _ opType: Godot.VisualShaderNodeSmoothStep.OpType
    ) {
    ...
    internal static var __method_binding_get_op_type: GDExtensionMethodBindPtr = {
        ...
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 359640855)!
        }
        }
    }()

    private func __getOpType() -> Godot.VisualShaderNodeSmoothStep.OpType {
        Godot.VisualShaderNodeSmoothStep.OpType.fromInitializingMutatingGodotUnsafePointer { __temporary in
        `self`.withGodotUnsafeMutableRawPointer { __ptr_self in
        GodotExtension.Interface.objectMethodBindPtrcall(
