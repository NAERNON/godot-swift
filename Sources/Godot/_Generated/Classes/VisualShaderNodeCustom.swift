...
open class VisualShaderNodeCustom: VisualShaderNode {
    ...
    open func _getInputPortType(
        port: Int32
    ) -> Godot.VisualShaderNode.PortType {
        Godot.VisualShaderNode.PortType(rawValue: 0)!
    }
    
    open func _getInputPortName(
        port: Int32
    ) -> Godot.GodotString {
        Godot.GodotString()
    }
    
    open func _getInputPortDefaultValue(
        port: Int32
    ) -> Godot.Variant {
        Variant()
    }
    
    open func _getDefaultInputPort(
    ...
    open func _getOutputPortType(
        port: Int32
    ) -> Godot.VisualShaderNode.PortType {
        Godot.VisualShaderNode.PortType(rawValue: 0)!
    }
    
    open func _getOutputPortName(
        port: Int32
    ) -> Godot.GodotString {
        Godot.GodotString()
    }
    ...
    open func _getPropertyName(
        index: Int32
    ) -> Godot.GodotString {
        Godot.GodotString()
    }
    
    open func _getPropertyDefaultIndex(
        _ index: Int32
    ) -> Int32 {
        Int32()
    }
    ...
    open func _getCode(
        inputVars: Godot.GodotArray<Godot.GodotString>,
        outputVars: Godot.GodotArray<Godot.GodotString>,
        mode: Godot.Shader.Mode,
        type: Godot.VisualShader.GodotType
    ) -> Godot.GodotString {
        Godot.GodotString()
    }
    
    open func _getFuncCode(
        mode: Godot.Shader.Mode,
        type: Godot.VisualShader.GodotType
    ) -> Godot.GodotString {
        Godot.GodotString()
    ...
    internal static var __method_binding_get_option_index: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
            GodotStringName(swiftStaticString: "get_option_index").withUnsafeOpaquePointer { __ptr__method_name in
    ...
    internal override class func virtualFunctions() -> [GodotStringName: (godotName: GodotStringName, call: GDExtensionClassCallVirtual)] {
        ...
        let _get_name_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            Unmanaged<VisualShaderNodeCustom>.fromOpaque(instancePtr)
                .takeUnretainedValue()
                ._getName()
