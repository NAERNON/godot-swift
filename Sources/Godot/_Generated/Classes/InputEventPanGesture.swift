...
open class InputEventPanGesture: InputEventGesture {
    private static var __method_binding_set_delta: GDExtensionMethodBindPtr = {
        ...
        GodotStringName(swiftString: "set_delta").withUnsafeRawPointer { __ptr__method_name in
    ...
    private static var __method_binding_get_delta: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_delta").withUnsafeRawPointer { __ptr__method_name in
