...
open class GridMap: Node3D {
    ...
    public lazy var cellSizeChangedSignal: Godot.SignalEmitter<CellSizeChangedSignalInput> = {
        .init(object: self, signalName: "cell_size_changed") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<CellSizeChangedSignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(cellSize: Godot.Vector3.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!)))
    ...
    private func __setBakeNavigation(
        ...
        withTransferrableUnsafeRawPointer(to: bakeNavigation) { __ptr_bakeNavigation in
    ...
    private func __setMeshLibrary(
        ...
        withTransferrableUnsafeRawPointer(to: meshLibrary) { __ptr_meshLibrary in
    ...
    public func makeBakedMeshes(
        ...
        withTransferrableUnsafeRawPointer(to: genLightmapUv) { __ptr_genLightmapUv in
            withTransferrableUnsafeRawPointer(to: lightmapUvTexelSize) { __ptr_lightmapUvTexelSize in
