...
open class EditorProperty: Container {
    ...
    public struct MultiplePropertiesChangedSignalInput: Godot.SignalInput {
        ...
        fileprivate init(properties: Godot.GodotContiguousArray<GodotString>, value: Godot.AnyGodotArray) {
    ...
    public func multiplePropertiesChanged(properties: Godot.GodotContiguousArray<GodotString>, value: Godot.AnyGodotArray) {
    ...
    internal override class func virtualFunctions() -> [GodotStringName: (godotName: GodotStringName, call: GDExtensionClassCallVirtual)] {
        ...
        let _update_property_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            Unmanaged<EditorProperty>.fromOpaque(instancePtr)
                .takeUnretainedValue()
                ._updateProperty()
        }
