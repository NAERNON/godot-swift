...
open class PhysicsDirectSpaceState2D: Object {
    ...
    public func intersectPoint(parameters: Godot.PhysicsPointQueryParameters2D?, maxResults: Int32 = 32) -> Godot.GodotArray<Godot.GodotDictionary<Variant, Variant>> {
    ...
    public func intersectRay(parameters: Godot.PhysicsRayQueryParameters2D?) -> Godot.GodotDictionary<Variant, Variant> {
    ...
    public func intersectShape(parameters: Godot.PhysicsShapeQueryParameters2D?, maxResults: Int32 = 32) -> Godot.GodotArray<Godot.GodotDictionary<Variant, Variant>> {
        let __temporary = Godot.GodotArray<Godot.GodotDictionary<Variant, Variant>>()
        parameters.withUnsafeRawPointer { (__ptr_parameters) in
            withUnsafePointer(to: __ptr_parameters) { (_ptr___ptr_parameters) in
                withUnsafePointer(to: maxResults) { (__ptr_maxResults) in
    ...
    public func restInfo(parameters: Godot.PhysicsShapeQueryParameters2D?) -> Godot.GodotDictionary<Variant, Variant> {
        let __temporary = Godot.GodotDictionary<Variant, Variant>()
        parameters.withUnsafeRawPointer { (__ptr_parameters) in
            withUnsafePointer(to: __ptr_parameters) { (_ptr___ptr_parameters) in
                withUnsafeArgumentPackPointer(_ptr___ptr_parameters) { (__accessPtr) in
