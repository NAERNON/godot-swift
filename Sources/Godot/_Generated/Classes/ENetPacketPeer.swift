...
open class ENetPacketPeer: PacketPeer {
    ...
    public func pingInterval(
        ...
        withTransferrableUnsafeRawPointer(to: pingInterval) { __ptr_pingInterval in
    ...
    public func throttleConfigure(
        ...
        withTransferrableUnsafeRawPointer(to: interval) { __ptr_interval in
            withTransferrableUnsafeRawPointer(to: acceleration) { __ptr_acceleration in
                withTransferrableUnsafeRawPointer(to: deceleration) { __ptr_deceleration in
    ...
    public func setTimeout(
        ...
        withTransferrableUnsafeRawPointer(to: timeout) { __ptr_timeout in
            withTransferrableUnsafeRawPointer(to: timeoutMin) { __ptr_timeoutMin in
                withTransferrableUnsafeRawPointer(to: timeoutMax) { __ptr_timeoutMax in
