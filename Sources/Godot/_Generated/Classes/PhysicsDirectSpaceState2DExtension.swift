...
open class PhysicsDirectSpaceState2DExtension: PhysicsDirectSpaceState2D {
    open func _intersectRay(
        ...
        hitFromInside: Bool,
        result: UnsafeMutablePointer<PhysicsServer2DExtensionRayResult>
    ) -> Bool {
        Bool()
    }
    ...
    open func _intersectPoint(
        ...
        collideWithBodies: Bool,
        collideWithAreas: Bool,
        results: UnsafeMutablePointer<PhysicsServer2DExtensionShapeResult>,
        maxResults: Int32
    ) -> Int32 {
        Int32()
    }
    ...
    open func _intersectShape(
        ...
        collideWithBodies: Bool,
        collideWithAreas: Bool,
        result: UnsafeMutablePointer<PhysicsServer2DExtensionShapeResult>,
        maxResults: Int32
    ) -> Int32 {
        Int32()
    }
    ...
    open func _restInfo(
        ...
        collideWithBodies: Bool,
        collideWithAreas: Bool,
        restInfo: UnsafeMutablePointer<PhysicsServer2DExtensionShapeRestInfo>
    ) -> Bool {
        Bool()
    }
