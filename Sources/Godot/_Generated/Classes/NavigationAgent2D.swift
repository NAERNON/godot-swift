...
open class NavigationAgent2D: Node {
    ...
    private func __setPathfindingAlgorithm(
        _ pathfindingAlgorithm: Godot.NavigationPathQueryParameters2D.PathfindingAlgorithm
    ) {
    ...
    private func __setPathPostprocessing(
        _ pathPostprocessing: Godot.NavigationPathQueryParameters2D.PathPostProcessing
    ) {
    ...
    private func __setPathMetadataFlags(
        _ flags: Godot.NavigationPathQueryParameters2D.PathMetadataFlags
    ) {
    ...
    internal static var __method_binding_set_debug_path_custom_line_width: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_debug_path_custom_line_width").withUnsafeOpaquePointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 373806689)!
        }
        }
    }()

    private func __setDebugPathCustomLineWidth(
        _ lineWidth: Double
    ) {
        withTransferrableUnsafeRawPointer(to: lineWidth) { __ptr_lineWidth in
    ...
    internal static var __method_binding_get_debug_path_custom_line_width: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "get_debug_path_custom_line_width").withUnsafeOpaquePointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 1740695150)!
        }
        }
    }()
