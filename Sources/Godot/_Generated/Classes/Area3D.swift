...
open class Area3D: CollisionObject3D {
    ...
    public struct BodyShapeEnteredSignalInput: Godot.SignalInput {
        ...
        fileprivate init(body_rid: Godot.RID, body: Godot.Node3D?, body_shape_index: Int, local_shape_index: Int) {
    ...
    public func bodyShapeEntered(body_rid: Godot.RID, body: Godot.Node3D?, body_shape_index: Int, local_shape_index: Int) {
    ...
    public func bodyShapeExited(body_rid: Godot.RID, body: Godot.Node3D?, body_shape_index: Int, local_shape_index: Int) {
    ...
    public struct AreaShapeEnteredSignalInput: Godot.SignalInput {
        ...
        public let local_shape_index: Int
        fileprivate init(area_rid: Godot.RID, area: Godot.Area3D?, area_shape_index: Int, local_shape_index: Int) {
    ...
    public func areaShapeEntered(area_rid: Godot.RID, area: Godot.Area3D?, area_shape_index: Int, local_shape_index: Int) {
    ...
    public func areaShapeExited(area_rid: Godot.RID, area: Godot.Area3D?, area_shape_index: Int, local_shape_index: Int) {
