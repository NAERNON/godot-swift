...
open class Area3D: CollisionObject3D {
    ...
    @Emitter(signal: "body_shape_exited", args: ("bodyRid", Godot.RID), ("body", Godot.Node3D?), ("bodyShapeIndex", Int), ("localShapeIndex", Int))
    public struct BodyShapeExited {
    }

    @Emitter(signal: "body_entered", args: ("body", Godot.Node3D?))
    public struct BodyEntered {
    }

    @Emitter(signal: "body_exited", args: ("body", Godot.Node3D?))
    public struct BodyExited {
    }

    @Emitter(signal: "area_shape_entered", args: ("areaRid", Godot.RID), ("area", Godot.Area3D?), ("areaShapeIndex", Int), ("localShapeIndex", Int))
    public struct AreaShapeEntered {
    }

    @Emitter(signal: "area_shape_exited", args: ("areaRid", Godot.RID), ("area", Godot.Area3D?), ("areaShapeIndex", Int), ("localShapeIndex", Int))
    public struct AreaShapeExited {
    }

    @Emitter(signal: "area_entered", args: ("area", Godot.Area3D?))
    public struct AreaEntered {
    }

    @Emitter(signal: "area_exited", args: ("area", Godot.Area3D?))
    ...
    private func __getGravitySpaceOverrideMode() -> Godot.Area3D.SpaceOverride {
        var __temporary = Godot.Area3D.SpaceOverride.RawValue(0)
        ...
        return Godot.Area3D.SpaceOverride(rawValue: __temporary)!
    }
    ...
    private func __setWindForceMagnitude(_ windForceMagnitude: Double) {
        withUnsafePointer(to: windForceMagnitude) { (__ptr_windForceMagnitude) in
    ...
    private func __setWindAttenuationFactor(_ windAttenuationFactor: Double) {
        withUnsafePointer(to: windAttenuationFactor) { (__ptr_windAttenuationFactor) in
    ...
    private func __setWindSourcePath(_ windSourcePath: Godot.NodePath) {
        windSourcePath.withUnsafeRawPointer { (__ptr_windSourcePath) in
    ...
    public func overlappingBodies() -> Godot.GodotTypedArray<Godot.Node3D?> {
    ...
    public func overlappingAreas() -> Godot.GodotTypedArray<Godot.Area3D?> {
        let __temporary = Godot.GodotTypedArray<Godot.Area3D?>()
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                gdextension_interface_object_method_bind_ptrcall(
