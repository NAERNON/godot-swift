...
open class PhysicsRayQueryParameters2D: RefCounted {
    private static var __method_binding_create: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 1118143851)!
        }
        }
    }()
    static public func create(from: Godot.Vector2, to: Godot.Vector2, collisionMask: UInt32 = 4294967295, exclude: Godot.GodotTypedArray<Godot.RID> = []) -> Godot.PhysicsRayQueryParameters2D? {
        ...
        return Godot.PhysicsRayQueryParameters2D.retrievedInstanceManagedByGodot(__temporary)
    }
    ...
    private static var __method_binding_set_to: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "set_to").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 743155724)!
        }
        }
    }()
    ...
    private static var __method_binding_get_to: GDExtensionMethodBindPtr = {
        _$staticClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftString: "get_to").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 3341600327)!
        }
        }
    }()
