...
open class GraphEdit: Control {
    ...
    public lazy var connectionRequestSignal: Godot.SignalEmitter<ConnectionRequestSignalInput> = {
        .init(object: self, signalName: "connection_request") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<ConnectionRequestSignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(fromNode: Godot.GodotStringName.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!),
                    fromPort: Int.convertFromStorage(unsafePointer: args!.advanced(by: 1).pointee!),
                    toNode: Godot.GodotStringName.convertFromStorage(unsafePointer: args!.advanced(by: 2).pointee!),
                    toPort: Int.convertFromStorage(unsafePointer: args!.advanced(by: 3).pointee!)))
    ...
    public lazy var connectionToEmptySignal: Godot.SignalEmitter<ConnectionToEmptySignalInput> = {
        .init(object: self, signalName: "connection_to_empty") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<ConnectionToEmptySignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(fromNode: Godot.GodotStringName.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!),
                    fromPort: Int.convertFromStorage(unsafePointer: args!.advanced(by: 1).pointee!),
                    releasePosition: Godot.Vector2.convertFromStorage(unsafePointer: args!.advanced(by: 2).pointee!)))
        } freeFunc: { callablePtr in
    ...
    public lazy var connectionFromEmptySignal: Godot.SignalEmitter<ConnectionFromEmptySignalInput> = {
        .init(object: self, signalName: "connection_from_empty") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<ConnectionFromEmptySignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(toNode: Godot.GodotStringName.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!),
                    toPort: Int.convertFromStorage(unsafePointer: args!.advanced(by: 1).pointee!),
                    releasePosition: Godot.Vector2.convertFromStorage(unsafePointer: args!.advanced(by: 2).pointee!)))
        } freeFunc: { callablePtr in
    ...
    public lazy var connectionDragStartedSignal: Godot.SignalEmitter<ConnectionDragStartedSignalInput> = {
        .init(object: self, signalName: "connection_drag_started") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<ConnectionDragStartedSignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(fromNode: Godot.GodotStringName.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!),
                    fromPort: Int.convertFromStorage(unsafePointer: args!.advanced(by: 1).pointee!),
                    isOutput: Bool.convertFromStorage(unsafePointer: args!.advanced(by: 2).pointee!)))
        } freeFunc: { callablePtr in
    ...
    public lazy var deleteNodesRequestSignal: Godot.SignalEmitter<DeleteNodesRequestSignalInput> = {
        .init(object: self, signalName: "delete_nodes_request") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<DeleteNodesRequestSignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(nodes: Godot.GodotArray<Godot.GodotStringName> .convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!)))
        } freeFunc: { callablePtr in
    ...
    public lazy var scrollOffsetChangedSignal: Godot.SignalEmitter<ScrollOffsetChangedSignalInput> = {
        .init(object: self, signalName: "scroll_offset_changed") { callablePtr, args, _, _, _ in
            Unmanaged<Godot.SignalReceiver<ScrollOffsetChangedSignalInput>> .fromOpaque(callablePtr!).takeUnretainedValue()
                .call(with: .init(offset: Godot.Vector2.convertFromStorage(unsafePointer: args!.advanced(by: 0).pointee!)))
        } freeFunc: { callablePtr in
    ...
    public func connectNode(
        ...
        fromInitializingTransferrableUnsafeRawPointer { __temporary in
            withTransferrableUnsafeRawPointer(to: fromNode) { __ptr_fromNode in
                withTransferrableUnsafeRawPointer(to: fromPort) { __ptr_fromPort in
                    withTransferrableUnsafeRawPointer(to: toNode) { __ptr_toNode in
                        withTransferrableUnsafeRawPointer(to: toPort) { __ptr_toPort in
    ...
    public func addValidConnectionType(
        ...
        withTransferrableUnsafeRawPointer(to: fromType) { __ptr_fromType in
            withTransferrableUnsafeRawPointer(to: toType) { __ptr_toType in
    ...
    private func __setPanningScheme(
        ...
        withTransferrableUnsafeRawPointer(to: scheme) { __ptr_scheme in
    ...
    private func __setZoomMin(
        ...
        withTransferrableUnsafeRawPointer(to: zoomMin) { __ptr_zoomMin in
    ...
    private func __setZoomMax(
        ...
        withTransferrableUnsafeRawPointer(to: zoomMax) { __ptr_zoomMax in
    ...
    private func __setZoomStep(
        ...
        withTransferrableUnsafeRawPointer(to: zoomStep) { __ptr_zoomStep in
    ...
    internal static var __method_binding_set_show_grid: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_grid").withUnsafeRawPointer { __ptr__method_name in
    ...
    internal static var __method_binding_is_showing_grid: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_grid").withUnsafeRawPointer { __ptr__method_name in
    ...
    internal static var __method_binding_set_snapping_enabled: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_snapping_enabled").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_snapping_enabled: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_snapping_enabled").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_set_snapping_distance: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_snapping_distance").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 1286410249)!
        }
        }
    }()
    ...
    internal static var __method_binding_get_snapping_distance: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "get_snapping_distance").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __setConnectionLinesCurvature(
        ...
        withTransferrableUnsafeRawPointer(to: curvature) { __ptr_curvature in
    ...
    private func __setMinimapOpacity(
        ...
        withTransferrableUnsafeRawPointer(to: opacity) { __ptr_opacity in
    ...
    internal static var __method_binding_set_show_menu: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_menu").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_showing_menu: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_menu").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_set_show_grid_buttons: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_grid_buttons").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_showing_grid_buttons: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_grid_buttons").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_set_show_zoom_buttons: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_zoom_buttons").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_showing_zoom_buttons: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_zoom_buttons").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_set_show_minimap_button: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_minimap_button").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_showing_minimap_button: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_minimap_button").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_set_show_arrange_button: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_show_arrange_button").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2586408642)!
        }
        }
    }()
    ...
    internal static var __method_binding_is_showing_arrange_button: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_showing_arrange_button").withUnsafeRawPointer { __ptr__method_name in
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 36873697)!
        }
        }
    }()
    ...
    internal static var __method_binding_get_menu_hbox: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "get_menu_hbox").withUnsafeRawPointer { __ptr__method_name in
