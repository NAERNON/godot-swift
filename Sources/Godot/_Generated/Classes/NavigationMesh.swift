...
open class NavigationMesh: Resource {
    ...
    private func __setSamplePartitionType(
        ...
        withTransferrableUnsafeRawPointer(to: samplePartitionType) { __ptr_samplePartitionType in
    ...
    private func __setParsedGeometryType(
        ...
        withTransferrableUnsafeRawPointer(to: geometryType) { __ptr_geometryType in
    ...
    private func __setAgentHeight(
        ...
        withTransferrableUnsafeRawPointer(to: agentHeight) { __ptr_agentHeight in
    ...
    private func __setAgentRadius(
        ...
        withTransferrableUnsafeRawPointer(to: agentRadius) { __ptr_agentRadius in
    ...
    private func __setAgentMaxClimb(
        ...
        withTransferrableUnsafeRawPointer(to: agentMaxClimb) { __ptr_agentMaxClimb in
    ...
    private func __setAgentMaxSlope(
        ...
        withTransferrableUnsafeRawPointer(to: agentMaxSlope) { __ptr_agentMaxSlope in
    ...
    private func __setRegionMinSize(
        ...
        withTransferrableUnsafeRawPointer(to: regionMinSize) { __ptr_regionMinSize in
    ...
    private func __setRegionMergeSize(
        ...
        withTransferrableUnsafeRawPointer(to: regionMergeSize) { __ptr_regionMergeSize in
    ...
    private func __setEdgeMaxLength(
        ...
        withTransferrableUnsafeRawPointer(to: edgeMaxLength) { __ptr_edgeMaxLength in
    ...
    private func __setEdgeMaxError(
        ...
        withTransferrableUnsafeRawPointer(to: edgeMaxError) { __ptr_edgeMaxError in
    ...
    private func __setVerticesPerPolygon(
        ...
        withTransferrableUnsafeRawPointer(to: verticesPerPolygon) { __ptr_verticesPerPolygon in
    ...
    private func __setDetailSampleDistance(
        ...
        withTransferrableUnsafeRawPointer(to: detailSampleDist) { __ptr_detailSampleDist in
    ...
    private func __setDetailSampleMaxError(
        ...
        withTransferrableUnsafeRawPointer(to: detailSampleMaxError) { __ptr_detailSampleMaxError in
    ...
    private func __setFilterLowHangingObstacles(
        ...
        withTransferrableUnsafeRawPointer(to: filterLowHangingObstacles) { __ptr_filterLowHangingObstacles in
    ...
    private func __setFilterLedgeSpans(
        ...
        withTransferrableUnsafeRawPointer(to: filterLedgeSpans) { __ptr_filterLedgeSpans in
    ...
    private func __setFilterWalkableLowHeightSpans(
        ...
        withTransferrableUnsafeRawPointer(to: filterWalkableLowHeightSpans) { __ptr_filterWalkableLowHeightSpans in
    ...
    private func __setFilterBakingAABB(
        ...
        withTransferrableUnsafeRawPointer(to: bakingAABB) { __ptr_bakingAABB in
    ...
    private func __setFilterBakingAABBOffset(
        ...
        withTransferrableUnsafeRawPointer(to: bakingAABBOffset) { __ptr_bakingAABBOffset in
