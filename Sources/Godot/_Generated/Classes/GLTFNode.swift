...
open class GLTFNode: Resource {
    ...
    private func __setMesh(_ mesh: Int32) {
        withUnsafePointer(to: mesh) { (__ptr_mesh) in
    ...
    private func __setCamera(_ camera: Int32) {
        withUnsafePointer(to: camera) { (__ptr_camera) in
    ...
    private func __setSkin(_ skin: Int32) {
        withUnsafePointer(to: skin) { (__ptr_skin) in
    ...
    private static var __method_binding_get_rotation: GDExtensionMethodBindPtr = {
        ...
        return gdextension_interface_classdb_get_method_bind(__ptr__class_name, __ptr__method_name, 2916281908)!
        }
        }
    }()
    ...
    private func __setChildren(_ children: Godot.PackedInt32Array) {
        children.withUnsafeRawPointer { (__ptr_children) in
    ...
    private func __setLight(_ light: Int32) {
        withUnsafePointer(to: light) { (__ptr_light) in
    ...
    public func setAdditionalData<Variant1 : VariantEncodable>(extensionName: Godot.GodotStringName, additionalData: Variant1) {
        extensionName.withUnsafeRawPointer { (__ptr_extensionName) in
            Godot.Variant.Storage(additionalData).withUnsafeRawPointer { (__ptr_additionalData) in
