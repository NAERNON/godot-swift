...
open class PathFollow2D: Node2D {
    ...
    internal static var __method_binding_set_rotates: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "set_rotates").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __setRotates(
        ...
        withTransferrableUnsafeRawPointer(to: enabled) { __ptr_enabled in
            withUnsafeArgumentPackPointer(__ptr_enabled) { __accessPtr in
                self.withUnsafeMutableRawPointer { __ptr_self in
                    GodotExtension.Interface.objectMethodBindPtrcall(
                        Self.__method_binding_set_rotates,
                        __ptr_self,
                        __accessPtr,
                        nil
                    )
    ...
    internal static var __method_binding_is_rotating: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeRawPointer { __ptr__class_name in
        GodotStringName(swiftStaticString: "is_rotating").withUnsafeRawPointer { __ptr__method_name in
    ...
    private func __isRotating() -> Bool {
        fromInitializingTransferrableUnsafeRawPointer { __temporary in
            self.withUnsafeMutableRawPointer { __ptr_self in
                GodotExtension.Interface.objectMethodBindPtrcall(
                    Self.__method_binding_is_rotating,
                    __ptr_self,
                    nil,
                    __temporary
                )
