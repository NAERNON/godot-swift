...
open class PathFollow2D: Node2D {
    ...
    internal static var __method_binding_set_rotates: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
            GodotStringName(swiftStaticString: "set_rotates").withUnsafeOpaquePointer { __ptr__method_name in
    ...
    internal static var __method_binding_is_rotating: GDExtensionMethodBindPtr = {
        _$exposedClassName.withUnsafeOpaquePointer { __ptr__class_name in
            GodotStringName(swiftStaticString: "is_rotating").withUnsafeOpaquePointer { __ptr__method_name in
