...
open class VisualShaderNodeVec4Parameter: VisualShaderNodeParameter {
    ...
    internal static var __method_binding_set_default_value: GDExtensionMethodBindPtr = {
        ...
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 643568085)!
        }
        }
    }()

    private func __setDefaultValue(
        _ value: Godot.Vector4
    ) {
    ...
    internal static var __method_binding_get_default_value: GDExtensionMethodBindPtr = {
        ...
        return GodotExtension.Interface.classdbGetMethodBind(__ptr__class_name, __ptr__method_name, 2435802345)!
        }
        }
    }()
