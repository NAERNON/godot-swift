...
open class OS: Object {
    ...
    private func __setLowProcessorUsageModeSleepUsec(_ usec: Int32) {
        withUnsafePointer(to: usec) { (__ptr_usec) in
    ...
    private func __setDeltaSmoothing(deltaSmoothingEnabled: Bool) {
        withUnsafePointer(to: deltaSmoothingEnabled) { (__ptr_deltaSmoothingEnabled) in
    ...
    public func systemFontPath(fontName: Godot.GodotString, weight: Int32 = 400, stretch: Int32 = 100, italic: Bool = false) -> Godot.GodotString {
        let __temporary = Godot.GodotString()
        fontName.withUnsafeRawPointer { (__ptr_fontName) in
    ...
    public func execute(path: Godot.GodotString, arguments: Godot.PackedStringArray, output: Godot.GodotArray = [], readStderr: Bool = false, openConsole: Bool = false) -> Int32 {
        var __temporary = Int32()
        path.withUnsafeRawPointer { (__ptr_path) in
            arguments.withUnsafeRawPointer { (__ptr_arguments) in
                output.withUnsafeRawPointer { (__ptr_output) in
                    withUnsafePointer(to: readStderr) { (__ptr_readStderr) in
                        withUnsafePointer(to: openConsole) { (__ptr_openConsole) in
    ...
    public func kill(pid: Int32) -> Godot.ErrorType {
        ...
        withUnsafePointer(to: pid) { (__ptr_pid) in
    ...
    public func shellShowInFileManager(fileOrDirPath: Godot.GodotString, openFolder: Bool = true) -> Godot.ErrorType {
        var __temporary = Godot.ErrorType.RawValue(0)
        fileOrDirPath.withUnsafeRawPointer { (__ptr_fileOrDirPath) in
            withUnsafePointer(to: openFolder) { (__ptr_openFolder) in
    ...
    public func hasEnvironment(variable: Godot.GodotString) -> Bool {
        var __temporary = Bool()
        variable.withUnsafeRawPointer { (__ptr_variable) in
    ...
    public func delayMsec(_ msec: Int32) {
        withUnsafePointer(to: msec) { (__ptr_msec) in
    ...
    public func memoryInfo() -> Godot.GodotDictionary {
    ...
    public func systemDir(_ dir: Godot.OS.SystemDir, sharedStorage: Bool = true) -> Godot.GodotString {
        ...
        withUnsafePointer(to: dir) { (__ptr_dir) in
            withUnsafePointer(to: sharedStorage) { (__ptr_sharedStorage) in
    ...
    public func hasFeature(tagName: Godot.GodotString) -> Bool {
        var __temporary = Bool()
        tagName.withUnsafeRawPointer { (__ptr_tagName) in
