...
open class PhysicsDirectBodyState3DExtension: PhysicsDirectBodyState3D {
    ...
    internal override class func virtualFunctions() -> [GodotStringName: (godotName: GodotStringName, call: GDExtensionClassCallVirtual)] {
        ...
        let _get_total_gravity_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            let instance = Unmanaged<PhysicsDirectBodyState3DExtension> .fromOpaque(instancePtr).takeUnretainedValue()
        ...
        returnPtr!.assumingMemoryBound(to: Godot.Basis.self).pointee = returnValue}
        ...
        let _set_linear_velocity_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            let _ = instance
        ._setLinearVelocity(
            args[0]!.load(as: Godot.Vector3.self)
        )}
        ...
        let _set_transform_call: GDExtensionClassCallVirtual = { instancePtr, args, returnPtr in
            ...
            let _ = instance
        ._setTransform(
            args[0]!.load(as: Godot.Transform3D.self)
        )}
        ...
        ._applyImpulse(
            args[0]!.load(as: Godot.Vector3.self),
            position: args[1]!.load(as: Godot.Vector3.self)
        )}
