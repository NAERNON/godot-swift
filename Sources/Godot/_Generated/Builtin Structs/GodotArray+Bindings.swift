...
extension GodotArray {
    ...
    static internal func _operatorEqual<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_equal_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorNotEqual<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_not_equal_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorLess<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_less_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorLessEqual<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_less_equal_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorGreater<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_greater_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorGreaterEqual<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.GodotArray<Value1>, _ rhs: Godot.GodotArray<Value2>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_greater_equal_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    __operator_binding_add_godotarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    internal func _front() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_front(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _back() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_back(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _pickRandom() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_pick_random(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    @discardableResult mutating internal func _popBack() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_pop_back(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    @discardableResult mutating internal func _popFront() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_pop_front(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    @discardableResult mutating internal func _popAt(position: Int) -> Godot.Variant.Storage {
        ...
        withUnsafePointer(to: position) { (__ptr_position) in
            withUnsafeArgumentPackPointer(__ptr_position) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_pop_at(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
            ...
            `func`.withUnsafeRawPointer { (__ptr_func) in
                withUnsafePointer(to: before) { (__ptr_before) in
                    withUnsafeArgumentPackPointer(__ptr_value, __ptr_func, __ptr_before) { (__accessPtr) in
                        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                            `self`.withUnsafeRawPointer { (__ptr_self) in
                                __method_binding_bsearch_custom(__ptr_self, __accessPtr, __ptr___temporary, 3)
                            }
                        }
                    }
                }
    ...
    internal func _duplicate(deep: Bool = false) -> Godot.GodotArray<Element> {
        let __temporary = Godot.GodotArray<Element>()
        withUnsafePointer(to: deep) { (__ptr_deep) in
            withUnsafeArgumentPackPointer(__ptr_deep) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_duplicate(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
                ...
                withUnsafePointer(to: step) { (__ptr_step) in
                    withUnsafePointer(to: deep) { (__ptr_deep) in
                        withUnsafeArgumentPackPointer(__ptr_begin, __ptr_end, __ptr_step, __ptr_deep) { (__accessPtr) in
                            __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                                `self`.withUnsafeRawPointer { (__ptr_self) in
                                    __method_binding_slice(__ptr_self, __accessPtr, __ptr___temporary, 4)
                                }
                            }
                        }
                    }
    ...
    internal func _filter(method: Godot.Callable) -> Godot.GodotArray<Element> {
        ...
        method.withUnsafeRawPointer { (__ptr_method) in
            withUnsafeArgumentPackPointer(__ptr_method) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_filter(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _map(method: Godot.Callable) -> Godot.GodotArray<Element> {
        ...
        method.withUnsafeRawPointer { (__ptr_method) in
            withUnsafeArgumentPackPointer(__ptr_method) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_map(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
        ...
        method.withUnsafeRawPointer { (__ptr_method) in
            Godot.Variant.withStorageUnsafeRawPointer(to: accum) { (__ptr_accum) in
                withUnsafeArgumentPackPointer(__ptr_method, __ptr_accum) { (__accessPtr) in
                    __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                        `self`.withUnsafeRawPointer { (__ptr_self) in
                            __method_binding_reduce(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
    ...
    internal func _any(method: Godot.Callable) -> Bool {
        ...
        method.withUnsafeRawPointer { (__ptr_method) in
            withUnsafeArgumentPackPointer(__ptr_method) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_any(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _all(method: Godot.Callable) -> Bool {
        ...
        method.withUnsafeRawPointer { (__ptr_method) in
            withUnsafeArgumentPackPointer(__ptr_method) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_all(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _max() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_max(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _min() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_min(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _isTyped() -> Bool {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_is_typed(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _isSameTyped<Value: VariantStorable>(array: Godot.GodotArray<Value>) -> Bool {
        ...
        array.withUnsafeRawPointer { (__ptr_array) in
            withUnsafeArgumentPackPointer(__ptr_array) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_is_same_typed(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _typedBuiltin() -> Int {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_typed_builtin(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _typedClassName() -> Godot.GodotStringName {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_typed_class_name(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _typedScript() -> Godot.Variant.Storage {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_typed_script(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _isReadOnly() -> Bool {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_is_read_only(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
