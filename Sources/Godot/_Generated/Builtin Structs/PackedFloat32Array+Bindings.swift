...
extension PackedFloat32Array {
    ...
    static internal func _operatorEqual(_ lhs: Godot.PackedFloat32Array, _ rhs: Godot.PackedFloat32Array) -> Bool {
        ...
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_equal_packedfloat32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.PackedFloat32Array, _ rhs: Godot.PackedFloat32Array) -> Bool {
        ...
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_not_equal_packedfloat32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }

    static internal func _operatorAdd(_ lhs: Godot.PackedFloat32Array, _ rhs: Godot.PackedFloat32Array) -> Godot.PackedFloat32Array {
        PackedFloat32Array.fromMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_add_packedfloat32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
