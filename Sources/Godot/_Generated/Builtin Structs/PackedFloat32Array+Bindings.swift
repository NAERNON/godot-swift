...
extension PackedFloat32Array {
    ...
    static internal func _operatorEqual<Value: VariantStorableIn>(_ lhs: Godot.PackedFloat32Array, _ rhs: Value) -> Bool {
    ...
    static internal func _operatorNotEqual<Value: VariantStorableIn>(_ lhs: Godot.PackedFloat32Array, _ rhs: Value) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            Godot.Variant.withStorageUnsafeRawPointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorIn<Value: VariantStorable>(_ lhs: Godot.PackedFloat32Array, _ rhs: Godot.GodotArray<Value>) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
