...
extension PackedColorArray {
    ...
    static internal func _operatorEqual<Value: VariantEncodable>(_ lhs: Godot.PackedColorArray, _ rhs: Value) -> Bool {
    ...
    static internal func _operatorNotEqual<Value: VariantEncodable>(_ lhs: Godot.PackedColorArray, _ rhs: Value) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            Godot.Variant.withStorageUnsafeRawPointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorIn<Value: VariantEncodable & VariantDecodable>(_ lhs: Godot.PackedColorArray, _ rhs: Godot.GodotArray<Value>) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorEqual(_ lhs: Godot.PackedColorArray, _ rhs: Godot.PackedColorArray) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_equal_packedcolorarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.PackedColorArray, _ rhs: Godot.PackedColorArray) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_not_equal_packedcolorarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    __operator_binding_add_packedcolorarray(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
