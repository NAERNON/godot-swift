...
extension PackedInt64Array {
    ...
    static internal func _operatorEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.PackedInt64Array, _ rhs: Variant1) -> Bool {
    ...
    static internal func _operatorNotEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.PackedInt64Array, _ rhs: Variant1) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.makeVariant().withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorIn(_ lhs: Godot.PackedInt64Array, _ rhs: Godot.GodotArray) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    private static var __operator_binding_equal_packedint64array: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorEqual(_ lhs: Godot.PackedInt64Array, _ rhs: Godot.PackedInt64Array) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_equal_packedint64array(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    private static var __operator_binding_not_equal_packedint64array: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.PackedInt64Array, _ rhs: Godot.PackedInt64Array) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_not_equal_packedint64array(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    private static var __operator_binding_add_packedint64array: GDExtensionPtrOperatorEvaluator = {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    Self.__operator_binding_add_packedint64array(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
