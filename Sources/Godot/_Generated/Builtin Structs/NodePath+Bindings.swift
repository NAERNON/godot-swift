...
extension NodePath {
    ...
    static internal func _operatorEqual<Variant1 : VariantEncodable>(_ lhs: Godot.NodePath, _ rhs: Variant1) -> Bool {
    ...
    static internal func _operatorNotEqual<Variant1 : VariantEncodable>(_ lhs: Godot.NodePath, _ rhs: Variant1) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            Godot.Variant.Storage(rhs).withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
