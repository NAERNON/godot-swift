...
extension NodePath {
    ...
    static internal func _operatorEqual(_ lhs: Godot.NodePath, _ rhs: Godot.NodePath) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_equal_nodepath(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.NodePath, _ rhs: Godot.NodePath) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_not_equal_nodepath(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorIn<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.NodePath, _ rhs: Godot.GodotDictionary<Value1, Value2>) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    internal func _isAbsolute() -> Bool {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_is_absolute(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _nameCount() -> Int {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_name_count(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
        ...
        withUnsafePointer(to: idx) { (__ptr_idx) in
            withUnsafeArgumentPackPointer(__ptr_idx) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_get_name(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _subnameCount() -> Int {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_subname_count(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _subname(idx: Int) -> Godot.GodotStringName {
        ...
        withUnsafePointer(to: idx) { (__ptr_idx) in
            withUnsafeArgumentPackPointer(__ptr_idx) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_get_subname(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    internal func _concatenatedNames() -> Godot.GodotStringName {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_concatenated_names(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _concatenatedSubnames() -> Godot.GodotStringName {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_concatenated_subnames(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    internal func _asPropertyPath() -> Godot.NodePath {
        ...
        __temporary.withUnsafeRawPointer { (__ptr___temporary) in
            `self`.withUnsafeRawPointer { (__ptr_self) in
                __method_binding_get_as_property_path(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
