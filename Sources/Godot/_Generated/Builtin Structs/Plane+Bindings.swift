...
extension Plane {
    ...
    private static var __constructor_plane: GDExtensionPtrConstructor = {
    ...
    static internal func _constructor_plane(from: Godot.Plane) -> Self {
        ...
        withUnsafePointer(to: from) { (__ptr_from) in
            withUnsafeArgumentPackPointer(__ptr_from) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { __ptr___temporary in
                    Self.__constructor_plane(__ptr___temporary, __accessPtr)
                }
            }
        }
        return __temporary
    ...
    private static var __constructor_vector3_vector3_vector3: GDExtensionPtrConstructor = {
            ...
            withUnsafePointer(to: point2) { (__ptr_point2) in
                withUnsafePointer(to: point3) { (__ptr_point3) in
                    withUnsafeArgumentPackPointer(__ptr_point1, __ptr_point2, __ptr_point3) { (__accessPtr) in
                        withUnsafeMutablePointer(to: &__temporary) { __ptr___temporary in
                            Self.__constructor_vector3_vector3_vector3(__ptr___temporary, __accessPtr)
                        }
                    }
                }
            }
    ...
    static internal func _operatorEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.Plane, _ rhs: Variant1) -> Bool {
    ...
    static internal func _operatorNotEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.Plane, _ rhs: Variant1) -> Bool {
        var __temporary = Bool()
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            rhs.makeVariant().withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    private static var __operator_binding_equal_plane: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorEqual(_ lhs: Godot.Plane, _ rhs: Godot.Plane) -> Bool {
        ...
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            withUnsafePointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_equal_plane(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    private static var __operator_binding_not_equal_plane: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.Plane, _ rhs: Godot.Plane) -> Bool {
        ...
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            withUnsafePointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_not_equal_plane(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorIn(_ lhs: Godot.Plane, _ rhs: Godot.GodotArray) -> Bool {
        var __temporary = Bool()
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
        ...
        withUnsafePointer(to: point) { (__ptr_point) in
            withUnsafeArgumentPackPointer(__ptr_point) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    withUnsafePointer(to: `self`) { (___ptr_self) in
                        let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                        Self.__method_binding_is_point_over(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
            ...
            withUnsafePointer(to: tolerance) { (__ptr_tolerance) in
                withUnsafeArgumentPackPointer(__ptr_point, __ptr_tolerance) { (__accessPtr) in
                    withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                        withUnsafePointer(to: `self`) { (___ptr_self) in
                            let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                            Self.__method_binding_has_point(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
            ...
            withUnsafePointer(to: c) { (__ptr_c) in
                withUnsafeArgumentPackPointer(__ptr_b, __ptr_c) { (__accessPtr) in
                    __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                        withUnsafePointer(to: `self`) { (___ptr_self) in
                            let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                            Self.__method_binding_intersect_3(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
            ...
            withUnsafePointer(to: dir) { (__ptr_dir) in
                withUnsafeArgumentPackPointer(__ptr_from, __ptr_dir) { (__accessPtr) in
                    __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                        withUnsafePointer(to: `self`) { (___ptr_self) in
                            let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                            Self.__method_binding_intersects_ray(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
            ...
            withUnsafePointer(to: to) { (__ptr_to) in
                withUnsafeArgumentPackPointer(__ptr_from, __ptr_to) { (__accessPtr) in
                    __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                        withUnsafePointer(to: `self`) { (___ptr_self) in
                            let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                            Self.__method_binding_intersects_segment(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
