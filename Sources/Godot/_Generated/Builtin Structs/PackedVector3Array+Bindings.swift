...
extension PackedVector3Array {
    ...
    static internal func _operatorMultiply(
        ...
        PackedVector3Array.fromInitializingMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
    ...
    internal func _slice(
        ...
        return Godot.PackedVector3Array.fromInitializingMutatingGodotUnsafePointer { __temporary in
