...
extension GodotStringName {
    ...
    static internal func _operatorEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.GodotStringName, _ rhs: Variant1) -> Bool {
    ...
    static internal func _operatorNotEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.GodotStringName, _ rhs: Variant1) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.makeVariant().withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorModule<Variant1 : ConvertibleToVariant>(_ lhs: Godot.GodotStringName, _ rhs: Variant1) -> Godot.GodotString {
