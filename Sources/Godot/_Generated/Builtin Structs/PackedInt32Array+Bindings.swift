...
extension PackedInt32Array {
    ...
    static internal func _operatorEqual(_ lhs: Godot.PackedInt32Array, _ rhs: Godot.PackedInt32Array) -> Bool {
        ...
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_equal_packedint32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.PackedInt32Array, _ rhs: Godot.PackedInt32Array) -> Bool {
        ...
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_not_equal_packedint32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }

    static internal func _operatorAdd(_ lhs: Godot.PackedInt32Array, _ rhs: Godot.PackedInt32Array) -> Godot.PackedInt32Array {
        PackedInt32Array.fromMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_add_packedint32array(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
