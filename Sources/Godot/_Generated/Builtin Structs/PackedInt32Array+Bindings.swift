...
extension PackedInt32Array {
    ...
    static internal func _operatorEqual<Value: VariantEncodable>(_ lhs: Godot.PackedInt32Array, _ rhs: Value) -> Bool {
    ...
    static internal func _operatorNotEqual<Value: VariantEncodable>(_ lhs: Godot.PackedInt32Array, _ rhs: Value) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            Godot.Variant.withStorageUnsafeRawPointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    static internal func _operatorIn(_ lhs: Godot.PackedInt32Array, _ rhs: Godot.GodotDictionary) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
    ...
    static internal func _operatorIn<Value: VariantEncodable & VariantDecodable>(_ lhs: Godot.PackedInt32Array, _ rhs: Godot.GodotArray<Value>) -> Bool {
        var __temporary = Bool()
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
