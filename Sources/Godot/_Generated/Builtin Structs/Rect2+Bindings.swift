...
private var __constructor: GDExtensionPtrConstructor = {
    return GodotExtension.Interface.variantGetPtrConstructor(GDEXTENSION_VARIANT_TYPE_RECT2, 0)!
}()
private var __constructor_rect2: GDExtensionPtrConstructor = {
    return GodotExtension.Interface.variantGetPtrConstructor(GDEXTENSION_VARIANT_TYPE_RECT2, 1)!
}()
private var __constructor_rect2i: GDExtensionPtrConstructor = {
    return GodotExtension.Interface.variantGetPtrConstructor(GDEXTENSION_VARIANT_TYPE_RECT2, 2)!
}()
private var __constructor_vector2_vector2: GDExtensionPtrConstructor = {
    return GodotExtension.Interface.variantGetPtrConstructor(GDEXTENSION_VARIANT_TYPE_RECT2, 3)!
}()
private var __constructor_float_float_float_float: GDExtensionPtrConstructor = {
    return GodotExtension.Interface.variantGetPtrConstructor(GDEXTENSION_VARIANT_TYPE_RECT2, 4)!
}()
private var __operator_binding_equal_variant: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_EQUAL, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_NIL)!
}()
private var __operator_binding_not_equal_variant: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_NOT_EQUAL, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_NIL)!
}()
private var __operator_binding_not: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_NOT, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_NIL)!
}()
private var __operator_binding_equal_rect2: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_EQUAL, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_RECT2)!
}()
private var __operator_binding_not_equal_rect2: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_NOT_EQUAL, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_RECT2)!
}()
private var __operator_binding_multiply_transform2d: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_MULTIPLY, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_TRANSFORM2D)!
}()
private var __operator_binding_in_godotdictionary: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_IN, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_DICTIONARY)!
}()
private var __operator_binding_in_godotarray: GDExtensionPtrOperatorEvaluator = {
    return GodotExtension.Interface.variantGetPtrOperatorEvaluator(GDEXTENSION_VARIANT_OP_IN, GDEXTENSION_VARIANT_TYPE_RECT2, GDEXTENSION_VARIANT_TYPE_ARRAY)!
}()
private var __method_binding_get_center: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 2428350749)!
    }
}()
private var __method_binding_get_area: GDExtensionPtrBuiltInMethod = {
    GodotStringName(swiftStaticString: "get_area").withGodotUnsafeRawPointer { __ptr__method_name in
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 466405837)!
    }
}()
private var __method_binding_has_area: GDExtensionPtrBuiltInMethod = {
    GodotStringName(swiftStaticString: "has_area").withGodotUnsafeRawPointer { __ptr__method_name in
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 3918633141)!
    }
}()
private var __method_binding_has_point: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 3190634762)!
    }
}()
private var __method_binding_is_equal_approx: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 1908192260)!
    }
}()
...
private var __method_binding_intersects: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 819294880)!
    }
}()
...
private var __method_binding_intersection: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 2282977743)!
    }
}()
...
private var __method_binding_expand: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 293272265)!
    }
}()
private var __method_binding_grow: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 39664498)!
    }
}()
private var __method_binding_grow_side: GDExtensionPtrBuiltInMethod = {
    GodotStringName(swiftStaticString: "grow_side").withGodotUnsafeRawPointer { __ptr__method_name in
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 4177736158)!
    }
}()
private var __method_binding_grow_individual: GDExtensionPtrBuiltInMethod = {
    GodotStringName(swiftStaticString: "grow_individual").withGodotUnsafeRawPointer { __ptr__method_name in
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 3203390369)!
    }
}()
private var __method_binding_abs: GDExtensionPtrBuiltInMethod = {
    ...
    return GodotExtension.Interface.variantGetPtrBuiltinMethod(GDEXTENSION_VARIANT_TYPE_RECT2, __ptr__method_name, 3107653634)!
    }
}()
extension Rect2 {
    ...
    static internal func _constructor_vector2_vector2(position: Godot.Vector2, size: Godot.Vector2) -> Self {
        ...
        withUnsafeMutablePointer(to: &__temporary) { __ptr___temporary in
            __constructor_vector2_vector2(__ptr___temporary, __accessPtr)
        }}}}
        return __temporary
    }
    ...
    static internal func _operatorEqual<Value: VariantStorableIn>(_ lhs: Godot.Rect2, _ rhs: Value) -> Bool {
    ...
    static internal func _operatorNotEqual<Value: VariantStorableIn>(_ lhs: Godot.Rect2, _ rhs: Value) -> Bool {
        Bool.fromMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        Godot.Variant.withStorageUnsafeRawPointer(to: rhs) { __ptr_rhs in
    ...
    static internal func _operatorEqual(_ lhs: Godot.Rect2, _ rhs: Godot.Rect2) -> Bool {
        ...
        __operator_binding_equal_rect2(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.Rect2, _ rhs: Godot.Rect2) -> Bool {
        ...
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
        __operator_binding_not_equal_rect2(__ptr_lhs, __ptr_rhs, __temporary)}}}
    }
    ...
    static internal func _operatorIn<Value1: VariantStorable, Value2: VariantStorable>(_ lhs: Godot.Rect2, _ rhs: Godot.GodotDictionary<Value1, Value2>) -> Bool {
        Bool.fromMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
    ...
    static internal func _operatorIn<Value: VariantStorable>(_ lhs: Godot.Rect2, _ rhs: Godot.GodotArray<Value>) -> Bool {
        Bool.fromMutatingGodotUnsafePointer { __temporary in
        lhs.withGodotUnsafeRawPointer { __ptr_lhs in
        rhs.withGodotUnsafeRawPointer { __ptr_rhs in
    ...
    internal func _intersects(b: Godot.Rect2, includeBorders: Bool = false) -> Bool {
        ...
        includeBorders.withGodotUnsafeRawPointer { __ptr_includeBorders in
        withUnsafeArgumentPackPointer(__ptr_b, __ptr_includeBorders) { __accessPtr in
        `self`.withGodotUnsafeRawPointer { __ptr_self in
        __method_binding_intersects(UnsafeMutableRawPointer(mutating: __ptr_self), __accessPtr, __temporary, 2)}}}}}
    }
