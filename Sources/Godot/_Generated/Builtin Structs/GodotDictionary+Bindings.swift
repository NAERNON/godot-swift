...
extension GodotDictionary {
    ...
    static internal func _operatorEqual<Value1: VariantStorable, Value2: VariantStorable, Value3: VariantStorable, Value4: VariantStorable>(_ lhs: Godot.GodotDictionary<Value1, Value2>, _ rhs: Godot.GodotDictionary<Value3, Value4>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_equal_godotdictionary(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorNotEqual<Value1: VariantStorable, Value2: VariantStorable, Value3: VariantStorable, Value4: VariantStorable>(_ lhs: Godot.GodotDictionary<Value1, Value2>, _ rhs: Godot.GodotDictionary<Value3, Value4>) -> Bool {
        ...
        lhs.withUnsafeRawPointer { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    __operator_binding_not_equal_godotdictionary(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    internal func _hasAll<Value: VariantStorable>(keys: Godot.GodotArray<Value>) -> Bool {
        ...
        keys.withUnsafeRawPointer { (__ptr_keys) in
            withUnsafeArgumentPackPointer(__ptr_keys) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_has_all(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
        ...
        Godot.Variant.withStorageUnsafeRawPointer(to: value) { (__ptr_value) in
            withUnsafeArgumentPackPointer(__ptr_value) { (__accessPtr) in
                __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_find_key(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    @discardableResult mutating internal func _erase<Value: VariantStorableIn>(key: Value) -> Bool {
        ...
        Godot.Variant.withStorageUnsafeRawPointer(to: key) { (__ptr_key) in
            withUnsafeArgumentPackPointer(__ptr_key) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    `self`.withUnsafeRawPointer { (__ptr_self) in
                        __method_binding_erase(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
        ...
        Godot.Variant.withStorageUnsafeRawPointer(to: key) { (__ptr_key) in
            Godot.Variant.withStorageUnsafeRawPointer(to: `default`) { (__ptr_default) in
                withUnsafeArgumentPackPointer(__ptr_key, __ptr_default) { (__accessPtr) in
                    __temporary.withUnsafeRawPointer { (__ptr___temporary) in
                        `self`.withUnsafeRawPointer { (__ptr_self) in
                            __method_binding_get(__ptr_self, __accessPtr, __ptr___temporary, 2)
                        }
                    }
                }
            }
