...
extension Basis {
    ...
    static internal func _operatorEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.Basis, _ rhs: Variant1) -> Bool {
    ...
    static internal func _operatorNotEqual<Variant1 : ConvertibleToVariant>(_ lhs: Godot.Basis, _ rhs: Variant1) -> Bool {
        var __temporary = Bool()
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            rhs.makeVariant().withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    private static var __operator_binding_equal_basis: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorEqual(_ lhs: Godot.Basis, _ rhs: Godot.Basis) -> Bool {
        ...
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            withUnsafePointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_equal_basis(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    private static var __operator_binding_not_equal_basis: GDExtensionPtrOperatorEvaluator = {
    ...
    static internal func _operatorNotEqual(_ lhs: Godot.Basis, _ rhs: Godot.Basis) -> Bool {
        ...
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            withUnsafePointer(to: rhs) { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__operator_binding_not_equal_basis(__ptr_lhs, __ptr_rhs, __ptr___temporary)
                }
            }
        }
        return __temporary
    ...
    static internal func _operatorIn(_ lhs: Godot.Basis, _ rhs: Godot.GodotArray) -> Bool {
        var __temporary = Bool()
        withUnsafePointer(to: lhs) { (__ptr_lhs) in
            rhs.withUnsafeRawPointer { (__ptr_rhs) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
    ...
    private static var __method_binding_transposed: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "transposed").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_BASIS, __ptr__method_name, 594669093)!
        }
    }()
    internal func _transposed() -> Godot.Basis {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            withUnsafePointer(to: `self`) { (___ptr_self) in
                let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                Self.__method_binding_transposed(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
    ...
    private static var __method_binding_tdotx: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "tdotx").withUnsafeRawPointer { __ptr__method_name in
        ...
        withUnsafePointer(to: with) { (__ptr_with) in
            withUnsafeArgumentPackPointer(__ptr_with) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    withUnsafePointer(to: `self`) { (___ptr_self) in
                        let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                        Self.__method_binding_tdotx(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    private static var __method_binding_tdoty: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "tdoty").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_BASIS, __ptr__method_name, 1047977935)!
        }
    }()
        ...
        withUnsafePointer(to: with) { (__ptr_with) in
            withUnsafeArgumentPackPointer(__ptr_with) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    withUnsafePointer(to: `self`) { (___ptr_self) in
                        let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                        Self.__method_binding_tdoty(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    private static var __method_binding_tdotz: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "tdotz").withUnsafeRawPointer { __ptr__method_name in
        return gdextension_interface_variant_get_ptr_builtin_method(GDEXTENSION_VARIANT_TYPE_BASIS, __ptr__method_name, 1047977935)!
        }
    }()
        ...
        withUnsafePointer(to: with) { (__ptr_with) in
            withUnsafeArgumentPackPointer(__ptr_with) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    withUnsafePointer(to: `self`) { (___ptr_self) in
                        let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                        Self.__method_binding_tdotz(__ptr_self, __accessPtr, __ptr___temporary, 1)
                    }
                }
            }
        }
    ...
    private static var __method_binding_get_rotation_quaternion: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "get_rotation_quaternion").withUnsafeRawPointer { __ptr__method_name in
    ...
    internal func _rotationQuaternion() -> Godot.Quaternion {
        ...
        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
            withUnsafePointer(to: `self`) { (___ptr_self) in
                let __ptr_self = UnsafeMutableRawPointer(mutating: ___ptr_self)
                Self.__method_binding_get_rotation_quaternion(__ptr_self, nil, __ptr___temporary, 0)
            }
        }
        return __temporary
    }
            ...
            withUnsafePointer(to: up) { (__ptr_up) in
                withUnsafePointer(to: useModelFront) { (__ptr_useModelFront) in
                    withUnsafeArgumentPackPointer(__ptr_target, __ptr_up, __ptr_useModelFront) { (__accessPtr) in
                        withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                            Self.__method_binding_looking_at(nil, __accessPtr, __ptr___temporary, 3)
                        }
                    }
                }
            }
    ...
    private static var __method_binding_from_scale: GDExtensionPtrBuiltInMethod = {
        GodotStringName(swiftString: "from_scale").withUnsafeRawPointer { __ptr__method_name in
    ...
    static internal func _fromScale(_ scale: Godot.Vector3) -> Godot.Basis {
        ...
        withUnsafePointer(to: scale) { (__ptr_scale) in
            withUnsafeArgumentPackPointer(__ptr_scale) { (__accessPtr) in
                withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                    Self.__method_binding_from_scale(nil, __accessPtr, __ptr___temporary, 1)
                }
            }
        }
        return __temporary
        ...
        withUnsafePointer(to: euler) { (__ptr_euler) in
            withUnsafePointer(to: order) { (__ptr_order) in
                withUnsafeArgumentPackPointer(__ptr_euler, __ptr_order) { (__accessPtr) in
                    withUnsafeMutablePointer(to: &__temporary) { (__ptr___temporary) in
                        Self.__method_binding_from_euler(nil, __accessPtr, __ptr___temporary, 2)
                    }
                }
            }
        }
