...
public struct Variant {
    ...
    public init(_ realValue: Real) {
        self.withUnsafeNativePointer { nativeTypePtr in
            withUnsafePointer(to: realValue) { otherNativeTypePtr in
...
#warning("DO THIS")
    ...
    /// Sets all the init bindings and the deinit used to communicate with Godot, as well as the static `interface` property.
    ///
