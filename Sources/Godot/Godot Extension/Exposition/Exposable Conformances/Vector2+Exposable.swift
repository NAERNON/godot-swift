...
extension Vector2: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .vector2
...
extension Vector2: GodotRawPointerAccessible {
