...
extension PackedColorArray: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .packedColorArray
...
extension PackedColorArray: Hintable {
...
extension PackedColorArray: Exposable {
    ...
    public static func transferFromGodot(
        ...
        Self._makeFromPackedColorArrayPointer(unsafePointer!)
    }
...
extension PackedColorArray: GodotRawPointerAccessible {
