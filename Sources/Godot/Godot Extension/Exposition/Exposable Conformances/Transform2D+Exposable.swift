...
extension Transform2D: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .transform2D
...
extension Transform2D: GodotRawPointerAccessible {
