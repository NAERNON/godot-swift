...
extension Rect2: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .rect2
...
extension Rect2: GodotRawPointerAccessible {
