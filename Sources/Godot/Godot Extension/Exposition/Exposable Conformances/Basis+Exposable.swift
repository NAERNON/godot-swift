...
extension Basis: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .basis
...
extension Basis: GodotRawPointerAccessible {
