...
extension PackedByteArray: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .packedByteArray
    ...
    public consuming func transferToGodot(
        ...
        withUnsafeOpaquePointer { selfPtr in
            withUnsafeArgumentPackPointer(selfPtr) { accessPtr in
                PackedByteArrayBindings.constructorFromPackedByteArray(destinationUnsafePointer, accessPtr)
            }
        }
    }
    ...
    public static func transferFromGodot(
        ...
        withUnsafeArgumentPackPointer(unsafePointer!) { accessPtr in
            opaque.withUnsafeMutableRawPointer { opaquePtr in
                PackedByteArrayBindings.constructorFromPackedByteArray(opaquePtr, accessPtr)
            }
        }
