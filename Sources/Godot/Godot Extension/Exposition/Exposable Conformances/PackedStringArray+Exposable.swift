...
extension PackedStringArray: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .packedStringArray
    ...
    public consuming func transferToGodot(
        ...
        withUnsafeOpaquePointer { selfPtr in
            withUnsafeArgumentPackPointer(selfPtr) { accessPtr in
                PackedStringArrayBindings.constructorFromPackedStringArray(destinationUnsafePointer, accessPtr)
            }
        }
    }
    ...
    public static func transferFromGodot(
        ...
        withUnsafeArgumentPackPointer(unsafePointer!) { accessPtr in
            opaque.withUnsafeMutableRawPointer { opaquePtr in
                PackedStringArrayBindings.constructorFromPackedStringArray(opaquePtr, accessPtr)
            }
        }
