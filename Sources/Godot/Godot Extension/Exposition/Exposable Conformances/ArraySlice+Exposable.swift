...
extension ArraySlice: Variant.Storable where Element : Variant.Storable {
...
extension ArraySlice: Hintable where Element : Exportable {
    public typealias HintingValue = Self
    public static var defaultHint: Hint<Self> { .elements(Element.defaultHint) }
}

extension ArraySlice: Exposable where Element : Exposable {
