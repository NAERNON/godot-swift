...
extension Vector4I: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .vector4I
...
extension Vector4I: GodotRawPointerAccessible {
