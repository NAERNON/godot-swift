...
extension Color: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .color
...
extension Color: GodotRawPointerAccessible {
