...
extension Plane: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .plane
...
extension Plane: GodotRawPointerAccessible {
