...
extension AABB: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .aabb
...
extension AABB: GodotRawPointerAccessible {
