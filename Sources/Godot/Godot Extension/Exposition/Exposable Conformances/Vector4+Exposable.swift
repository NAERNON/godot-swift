...
extension Vector4: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .vector4
...
extension Vector4: GodotRawPointerAccessible {
