...
extension Vector3I: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .vector3I
...
extension Vector3I: GodotRawPointerAccessible {
