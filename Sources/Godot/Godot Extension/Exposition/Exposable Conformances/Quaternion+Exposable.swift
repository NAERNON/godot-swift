...
extension Quaternion: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .quaternion
...
extension Quaternion: GodotRawPointerAccessible {
