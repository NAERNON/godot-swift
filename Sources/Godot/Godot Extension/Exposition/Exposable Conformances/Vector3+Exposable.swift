...
extension Vector3: Variant.Storable {
    public static let variantStorageType: Variant.StorageType? = .vector3
...
extension Vector3: GodotRawPointerAccessible {
