...
extension GodotExtension {
    ...
    public static func description<Value>(
        ...
        GodotString(describing: instance).transferToGodot(unsafePointer: out!)
    }
    ...
    where Value : CustomObject & RefCounted {
        let instance = Value()
    ...
    public static func referenceCallback<Value>(
        ...
        instancePtr: UnsafeMutableRawPointer?,
        reference: UInt8
    ) -> UInt8 where Value : CustomObject {
        return 1
    }
    ...
    public static func referenceCallback<Value>(
        ...
        instancePtr: UnsafeMutableRawPointer?,
        reference: UInt8
    ) -> UInt8 where Value : CustomObject & RefCounted {
