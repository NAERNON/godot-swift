...
extension Rect2 {
    ...
    /// // Prints (-2, -2, 12, 8)
    /// ```
    public func grow(by amount: FloatingPointType) -> Rect2 {
        _grow(amount: amount)
    }
    ...
    ///
    /// A negative amount shrinks the rectangle, instead.
    public func grow(by amount: FloatingPointType, side: Side) -> Rect2 {
    ...
    ///
    /// A negative amount shrinks the rectangle, instead.
    public func grow(by amount: FloatingPointType, sides: Side.Set) -> Rect2 {
        var copy = self
    ...
    public func grow(left: FloatingPointType, top: FloatingPointType, right: FloatingPointType, bottom: FloatingPointType) -> Rect2 {
