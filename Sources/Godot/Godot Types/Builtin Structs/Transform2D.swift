...
extension Transform2D {
    ...
    public init<T>(rotation: T, position: Vector2) where T : BinaryFloatingPoint {
        self.init(rotation: FloatingPointType(rotation), position: position)
    }
    ...
    ///   - position: The transform position.
    public init(rotation: FloatingPointType, scale: Vector2, skew: FloatingPointType, position: Vector2) {
    ...
    public init<T>(rotation: T, scale: Vector2, skew: T, position: Vector2) where T : BinaryFloatingPoint {
        self.init(
            rotation: FloatingPointType(rotation),
            scale: scale,
            skew: FloatingPointType(skew),
            position: position
        )
    }
    ...
    public func interpolation(with other: Transform2D, weight: FloatingPointType) -> Transform2D {
