...
public final class Variant {
    ...
    internal static func loadBindings() {
        ...
        UInt8GodotContiguousArrayStorageBindings.loadBindings()
        ColorGodotContiguousArrayStorageBindings.loadBindings()
        FloatGodotContiguousArrayStorageBindings.loadBindings()
        DoubleGodotContiguousArrayStorageBindings.loadBindings()
        Int32GodotContiguousArrayStorageBindings.loadBindings()
        Int64GodotContiguousArrayStorageBindings.loadBindings()
        GodotStringGodotContiguousArrayStorageBindings.loadBindings()
        Vector2GodotContiguousArrayStorageBindings.loadBindings()
        Vector3GodotContiguousArrayStorageBindings.loadBindings()
