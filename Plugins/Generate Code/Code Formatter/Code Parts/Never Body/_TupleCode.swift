...
public struct _TupleCode6<C0, C1, C2, C3, C4, C5>: SwiftCode
where C0: SwiftCode,
      C1: SwiftCode,
      C2: SwiftCode,
      C3: SwiftCode,
      ...
      C5: SwiftCode
{
    ...
    init(_ code0: C0, _ code1: C1, _ code2: C2, _ code3: C3, _ code4: C4, _ code5: C5) {
        self.code0 = code0
        self.code1 = code1
        self.code2 = code2
        self.code3 = code3
...
public struct _TupleCode7<C0, C1, C2, C3, C4, C5, C6>: SwiftCode
where C0: SwiftCode,
      C1: SwiftCode,
      C2: SwiftCode,
      C3: SwiftCode,
      ...
      C6: SwiftCode
{
    ...
    init(_ code0: C0, _ code1: C1, _ code2: C2, _ code3: C3, _ code4: C4, _ code5: C5, _ code6: C6) {
        self.code0 = code0
        self.code1 = code1
        self.code2 = code2
        self.code3 = code3
